...
| Параметр | Тип                                                        | Обязательный | Описание         |
| -------- | ---------------------------------------------------------- | ------------ | ---------------- |
| options  | [CreateChannelOptions](data-types/createchanneloptions.md) | Да           | Опции для канала |
...
| options   | [CreateThreadOptions](data-types/createchanneloptions.md) | Да           | Опции для ветки                                     |
...
| Параметр | Тип                                                  | Обязательный | Описание         |
| -------- | ---------------------------------------------------- | ------------ | ---------------- |
| options  | [DeferReplyOptions](data-types/deferreplyoptions.md) | Нет          | Опции для ответа |
...
| Параметр | Тип                                            | Обязательный | Описание         |
| -------- | ---------------------------------------------- | ------------ | ---------------- |
| options  | [MessageOptions](data-types/messageoptions.md) | Да           | Опции для ответа |
...
| Параметр | Тип                                        | Обязательный | Описание         |
| -------- | ------------------------------------------ | ------------ | ---------------- |
| options  | [ReplyOptions](data-types/replyoptions.md) | Да           | Опции для ответа |
...
| Параметр | Тип                                                | Обязательный | Описание              |
| -------- | -------------------------------------------------- | ------------ | --------------------- |
| options  | [ShowModalOptions](data-types/showmodaloptions.md) | Да           | Опции модального окна |
...
| options   | [MessageOptions](data-types/messageoptions.md) | Да           | Опции для сообщения                                        |
